...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Héritage, une histoire de famille.">
    <meta name="keywords" content="Héritage seconde guerre mondiale italie belgique immigration mussolini fascisme histoire Paolino Modolo Pauline Lagage"> 
    <link rel="icon" href="images/menu/favicon.ico" />
 ...
 <?php
    if(isset($_GET['email'])) 
    {
        ...
        if (preg_match("#^[a-z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,4}$#", $_POST['email'])) 
        {
            ...
            $email = $_POST['email'];
            $message = 'Pour valider votre inscription, veuillez <a href="http://www.paulinelagage.be/tfe/juin/inscription.php?tru=1&amp;email='.$email.'">confirmer votre adresse email</a>.';
            ...
            $headers .= 'From: Heritage' . "\r\n";
                ...
                echo "<p class='confirmation'>Un email de confirmation vient de vous être envoyé.</p><br> <p>Retour</p>";
                }
                else
                {
...
<div class="container">
<p> Pour vous désinscrire, veuillez confirmer votre adresse email. </p>
<form method="post" action="nouvelles.php?email=1">
<input type="text" class="mail" label="email" name="email"/><br />
<input class="hidden"  type="radio" name="new" value="0" />
<input checked class="hidden" type="radio" name="new" value="1" /><br/>
